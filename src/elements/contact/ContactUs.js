...
export function ContactUs() {
    ...
    //       .then((result) => {
    //           console.log(result.text);  // zmienic na usestate z info o pomyslnym wyslaniu lub bledzie
    //       }, (error) => {
    ...
    // //zrobic formularz kontrolowany, w state trzymac powiazania z polami this.state, onChange
